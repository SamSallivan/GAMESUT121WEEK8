...
public class BloodKingMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D detection1 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(side, 0), 25f, playerLayer);
        RaycastHit2D detection2 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(-side, 0), 25f, playerLayer);
        RaycastHit2D detection3 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(side, 0), 15f, playerLayer);
        RaycastHit2D detection4 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(-side, 0), 15f, playerLayer);
    ...
    void OnDrawGizmos()
    {
        ...
        RaycastHit2D detection1 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(side, 0f), 25f, playerLayer);
        if (detection1.collider)
        {
            Debug.DrawRay(transform.position + new Vector3(0, -0.5f), new Vector2(side, 0f) * 25f, Color.red);
        }
        else
        {
            Debug.DrawRay(transform.position + new Vector3(0, -0.5f), new Vector2(side, 0f) * 25f, Color.blue);
        }
        RaycastHit2D detection2 = Physics2D.Raycast(transform.position + new Vector3(0, -0.5f), new Vector2(-side, 0f), 25f, playerLayer);
